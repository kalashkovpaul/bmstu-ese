...
\begin{figure}[h!]
	\includegraphics[scale=0.8, center]{lab01_train}
\end{figure}
...
\begin{figure}[h!]
	\includegraphics[scale=0.5, center]{lab01_train_params}
\end{figure}

\begin{figure}[h!]
	\includegraphics[scale=0.5, center]{lab01_train-result}
\end{figure}
...
\begin{figure}[h!]
	\includegraphics[scale=0.5, center]{lab01_task1_1}
\end{figure}
...
\begin{figure}[h!]
	\includegraphics[scale=0.35, center]{lab01_task1_4}
\end{figure}

После этого отредактируем заметку о суммарной задаче:

\begin{figure}[h!]
	\includegraphics[scale=0.5, center]{lab01_task1_5}
\end{figure}
...
\begin{figure}[h!]
	\includegraphics[scale=0.4, center]{lab01_task2}
\end{figure}
\clearpage
...
\begin{figure}[h!]
	\includegraphics[scale=0.4, center]{lab01_task3}
\end{figure}
\clearpage
...
\begin{figure}[h!]
	\includegraphics[scale=0.4, center]{lab01_task4_1}
\end{figure}

\begin{figure}[h!]
	\includegraphics[scale=0.4, center]{lab01_task4_2}
\end{figure}
